...
public class CustomerTenantController {
	...
	// @RequestMapping(value = "newCustomer/createNewTenant", method =
	// RequestMethod.POST)
	...
	public ModelAndView submitNewTenant(@ModelAttribute Tenant tenant,
	...
	public ModelAndView deleteNewTenant(HttpServletRequest request,	@ModelAttribute Customer customer) {
